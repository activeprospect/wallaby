defmodule Wallaby.ProcessWorkspaceTest do
  use ExUnit.Case, async: true

  alias Wallaby.ProcessWorkspace
  alias Wallaby.ProcessWorkspace.TemporaryPath
  ...
  describe "create/2" do
    ...
    test "when workspace_path already exists" do
    ...
    test "creates a workspace dir using the tmp_dir_prefix setting" do
      {:ok, test_server} = TestServer.start_link()
      {:ok, workspace_path} = ProcessWorkspace.create(test_server)
